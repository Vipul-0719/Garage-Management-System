...
error_reporting(0);
$id = $_GET['id'];
$sql = "SELECT * FROM `header_line` WHERE `id`='$id'";
                        ...
                        <div class="form-body">
                            <div class="card-body">
                                <div class="row p-t-20">
                                    <div class="col-md-2">
                                        <div class="form-group has-success">
                                            ...
                                            <select class="form-control custom-select" id="branchID" name="branchID[]" placeholder="branchID">
                                                <option value=""></option>
                                                <?php
                                                include '../connect.php';
                                                ...
                                                ?>
                                                    <option value="<?php echo $r["id"] . ',' . $r["branchID"]; ?>"><?php echo $r["branchID"]; ?></option>
                                                <?php
                                                }
                                                ?>
                                ...
                                <div class="row p-t-20" id="add_item">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <select class="form-control custom-select" id="productnm" name="productnm[]" placeholder="itemName" value="<?php echo $rows['productnm']; ?>">
                                                <option value=""></option>
                                                <?php
                                                include '../connect.php';
                                    ...
                                    <div class="col-sm-1">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="hsnno" name="hsnno[]" placeholder="HSN/SAC" value="<?php echo $rows['hsnno']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-1">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="gst" name="gst[]" placeholder="GST Rate" value="<?php echo $rows['gst']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-1">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="qty" name="qty[]" placeholder="Quantity" value="<?php echo $rows['qty']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-1">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="unit" name="unit[]" placeholder="Unit" value="<?php echo $rows['unit']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-1">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="sprice" name="sprice[]" placeholder="Sale Price" value="<?php echo $rows['sprice']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-1">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="disc" name="disc[]" placeholder="Discount" value="<?php echo $rows['disc']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div class="form-group">
                                            <textarea class="form-control" id="description" name="description[]" placeholder="description" value="<?php echo $rows['description']; ?>"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="amount" name="amount[]" placeholder="Amount" value="<?php echo $rows['amount']; ?>">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <form class="m-t-20">
                                                    ...
                                                    <input class="form-check-input" type="text" id="shipping" name="shipping"><br><br>
                                                    ...
                                                    <input class="form-check-input" type="text" id="shipping" name="shipping"><br>
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-4">
                                    <div class="card">
                                        <div class="card-body">
                                            <form class="m-t-20">
                                                <label class="form-check-label" for="inlineCheckbox1">
                                                    <h5>Sub Total</h5>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                                                </label>
                                                <input class="form-check-input" type="text" id="shipping" name="shipping"><br><br>
                                                <label class="form-check-label" for="inlineCheckbox1">
                                                    <h4>Total Amount</h4>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                                                </label>
                                                <input class="form-check-input" type="text" id="shipping" name="shipping"><br>
                                            </form>
                                        </div>
