        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(../../assets/images/background/login-register.jpg) no-repeat center center;">
            <div class="auth-box on-sidebar">
                <div id="loginform">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form class="form-horizontal m-t-20" id="loginform" action="<?php echo base_url.'module\garageMaster\add2.php'; ?>" method="POST">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg"  id="password" name="password" placeholder="Password" aria-label="Password" aria-describedby="basic-addon1">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="role" name="role"><i class="ti-user"></i></span>
                                                <select class="form-control form-control-lg " id="role" data-placeholder="" name="role" >
                ...
                <div id="recoverform">
                    ...
                    <div class="row m-t-20">
                        <!-- Form -->
                        <form class="col-12" action="<?php echo base_url.'module\garageMaster\add2.php'; ?>" method="POST">
                            <!-- email -->
                            <div class="form-group row">
                                <div class="col-12">
